...
export default function LoginPage({searchParams}:{searchParams?:{error?:string}}){
  ...
  return <main className="login-page">{configured?<div className="login-page-stack">
    ...
    {disabledError&&<div className="login-global-error">Dit PULSE-account is uitgeschakeld. Neem contact op met een beheerder.</div>}
    <LoginForm/>
    ...
    <div className="auth-setup-note">Voer daarnaast één keer de meegeleverde Supabase-migraties uit en maak je gebruikers aan onder Auth → Users. PULSE blijft gesloten zolang Supabase Auth niet is geconfigureerd.</div>
  </div>}</main>
}
