...
const songSeed: SongText[] = [
  ...
  { id: "s2", artist: "ANOTR & 54 Ultra", title: "Talk To You", text: "Nieuwe muziek van ANOTR en 54 Ultra. Deze week nieuw in onze playlist: Talk To You.", notes: "Kan gelinkt worden aan de nieuwe muziekmeeting.", tags: ["Nieuw", "Dance"] },
...
const templateSeed: ProgramTemplate[] = [
  ...
  { id: "p2", program: "Drive", presenter: "Bram & Tibo", intro: "Dit is Drive op {station}: jouw soundtrack naar huis.", items: [
    ...
    { id: "pi6", name: "Coming up", type: "Playlist item", instruction: "Noem 2 komende tracks en 1 redactie-item.", sample: "Straks {next_song_1}, {next_song_2} en om half het nieuws." },
  ]},
];
