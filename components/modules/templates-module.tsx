...
const actions:[Action,string][]=[["instruction","Toon instructie"],["notification","Stuur teammelding"],["task","Maak taak"],["playlist_marker","Playlist-marker / opdracht"],["check","Controlepunt"]];
